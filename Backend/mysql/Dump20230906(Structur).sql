...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='50';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product` (
  ...
  `purl2` varchar(200) DEFAULT NULL,
  `mid` varchar(20) DEFAULT NULL,
...
CREATE TABLE `reply` (
  ...
  PRIMARY KEY (`rno`),
  KEY `mid` (`mid`),
  KEY `reply_ibfk_2_idx` (`pno`),
  CONSTRAINT `reply_ibfk_1` FOREIGN KEY (`mid`) REFERENCES `member` (`mid`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-06 17:51:05
