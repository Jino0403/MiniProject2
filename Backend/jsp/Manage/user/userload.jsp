...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../../../Styles/CSS/managePage.css" />
  <script src="../../../../Styles/Javascript/userdel.js" defer></script>
  <title>관리자 페이지</title>
</head>
<body>
<div id="manage_wrapper">
  <main>
    <div class="manage_menu">
      <div>
        <a href="../../manageMain.jsp"><img src="../../../../Styles/images/mainLogo.png" /></a>
        <h3>관리자페이지</h3>
        <ul id="nav_bar2">
          <li class="menu_bar2">
